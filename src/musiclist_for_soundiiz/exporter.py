...
class JSONExporter(BaseExporter):
    ...
    def export(self, metadata_list: List[Dict[str, str]], output_path: str) -> None:
        ...
        logger.info(f"Exported {len(metadata_list)} songs to {output_path_obj}")
...
class M3UExporter(BaseExporter):
    ...
    def export(self, metadata_list: List[Dict[str, str]], output_path: str) -> None:
        """
        Export metadata to M3U playlist file.
...
class TXTExporter(BaseExporter):
    ...
    def export(self, metadata_list: List[Dict[str, str]], output_path: str) -> None:
        """
        Export metadata to text file (format: Title - Artist).
