...
class MusicFileExtractor:
    ...
    def extract_metadata(self, file_path: Path) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with keys: title, artist, album, isrc, genre, year, duration, file_path, filename
    ...
    def extract_all(self, directory: str, recursive: bool = True) -> List[Dict[str, Any]]:
        """
